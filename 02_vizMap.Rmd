...
for (lang in colnames(txt)) {
  ...
  map <- ggplot(ddd) + 
    coord_quickmap(xlim = c(5.7,10.8), ylim = c(45.7, 47.8), expand = F) + 
    #coord_map(xlim = c(5.7,10.8), ylim = c(45.7, 47.8)) + 
    geom_polygon(data = world.df, aes(long, lat, group = group), 
                 colour = "white", size = 0.3, alpha = 0.5, fill = "#404040") +
  ...
  footer <- paste0(txt['source', lang], ": ", txt['source.name', lang])
    ...
    save_html(
      tags$html(
        ...
        tags$body(    
          h2(txt["title", lang]),
          div(class = "descr", HTML(paste0(txt["descr", lang],  '&nbsp; &nbsp; <img src="Interactive_icon.svg.png" width="23" align="top">'))),
